  ...
  return useQuery({
    ...
    queryFn: async () => {
      const { data } = await api.get(
        `${ieltsEndpoint}?page=${page}&limit=${limit}`
      );
      return data;
    },
  });
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      notification.success({
        message: "Yangi IELTS yaratildi",
        placement: "bottomRight",
      });
    },
    onError: () => {
      notification.error({
        message: "IELTS yaratishda xatolik yuz berdi",
        placement: "bottomRight",
      });
    },
  });
...
export const useUpdateIelts = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["ielts"] });
      notification.success({
        message: "IELTS yangilandi",
        placement: "bottomRight",
      });
    },
    onError: () => {
      notification.error({
        message: "IELTS yangilashda xatolik yuz berdi",
        placement: "bottomRight",
      });
    },
  });
...
export const useDeleteIelts = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["ielts"] });
      notification.success({
        message: "IELTS o'chirildi",
        placement: "bottomRight",
      });
    },
    onError: () => {
      notification.error({
        message: "IELTS o'chirishda xatolik yuz berdi",
        placement: "bottomRight",
      });
    },
  });
