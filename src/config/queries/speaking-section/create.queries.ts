...
import { ApiResponse, CreateSpeakingSection, SpeakingSection } from '@/utils/types/types'
...
export const useCreateSpeakingSection = () => {
	...
	return useMutation({
		mutationFn: async (data: CreateSpeakingSection) =>
			(await axiosPrivate.post<ApiResponse<SpeakingSection>>(speakingSectionEndpoints.all, data)).data,
		onSuccess: () => {
