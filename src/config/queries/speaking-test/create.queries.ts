...
import { ApiResponse, CreateSpeakingTest, SpeakingTest, CreateOnlySpeakingTest, OnlySpeakingTest } from '@/utils/types/types'
...
export const useCreateSpeakingTest = () => {
	...
	return useMutation({
		mutationFn: async (data: CreateSpeakingTest) =>
			(await axiosPrivate.post<ApiResponse<SpeakingTest>>(speakingTestEndpoints.all, data)).data,
		onSuccess: () => {
...
export const useCreateOnlySpeakingTest = () => {
	...
	return useMutation({
		mutationFn: async (data: CreateOnlySpeakingTest) =>
			(await axiosPrivate.post<ApiResponse<OnlySpeakingTest>>(speakingTestEndpoints.only, data)).data,
		onSuccess: () => {
