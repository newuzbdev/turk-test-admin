...
export const AntProvider = ({ children }: PropsWithChildren) => {
    ...
    const primaryColor = isDark ? '#2196f3' : '#2196f3' // Indigo shade
            ...
            theme={{
                ...
                components: {
                    ...
                    Card: {
                        ...
                        boxShadow: isDark ? '0 1px 3px 0 rgba(0, 0, 0, 0.3), 0 1px 2px -1px rgba(0, 0, 0, 0.3)' : '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)',
                    },
                    // Dropdown component
                    Dropdown: {
                        controlItemBgActive: isDark ? '#363850' : '#F3F4F6',
                        controlItemBgActiveHover: isDark ? primaryColor : `${primaryColor}20`,
                    },
