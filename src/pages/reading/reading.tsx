...
import ReadingForm from '../../components/test/ReadingForm';
...
export default function Reading() {
    ...
    const readingData = (data?.data || []).filter((item: any) => item.type === 'READING');
                        ...
                        initialData={
                            editingTest
                                ? {
                                    ...
                                    parts: editingTest.parts.map(({ number, title, sections }) => ({
                                        number,
                                        title,
                                        sections,
                                    })),
