...
import type { SpeakingSection, SpeakingSubPart } from "../../../utils/types/types";
...
export default function SpeakingSectionForm({ section, onChange, onRemove }: Props) {
                    ...
                    {sec.subParts.map((sp, i) => (
                        ...
                        >
                            ...
                            <Input.TextArea
                                ...
                                rows={2}
                            />
                            {/* Qo‘shimcha savollar (questions) ham shu yerga qo‘shilishi mumkin */}
                        </Card>
                    ))}
