...
describe('PointForm', () => {
  const mockPoint: SpeakingPoint = {
    ...
    questions: [
      { id: '1', question: 'Test question', order: 1 }
    ],
    example: [
  ...
  it('calls onAddQuestion when add question button is clicked', () => {
    ...
    const addQuestionButton = screen.getByText("Question qo'shish");
    fireEvent.click(addQuestionButton);
    
    expect(mockProps.onAddQuestion).toHaveBeenCalledWith(0, 0);
  });
  ...
  it('handles no examples', () => {
    ...
    expect(screen.queryByDisplayValue('Test example 1')).not.toBeInTheDocument();
  });
  ...
  it('calls onDelete when delete button is clicked', () => {
    ...
    const deletePointButton = deleteButtons.find(button => 
