    ...
    return (
        ...
        >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <Text strong style={{ color: '#1f2937' }}>📖 Bo'lim</Text>
                <Button
                    danger
                    type='text'
                    icon={<DeleteOutlined />}
            ...
            <div style={{ marginBottom: '12px' }}>
                <Text strong style={{ color: '#374151', fontSize: '14px' }}>❓ Savollar</Text>
            </div>
            ...
            <Space direction='vertical' style={{ width: '100%' }}>
                {section.questions.map((q, qIdx) => (
                    ...
                    >
                        ...
                        <div style={{ marginBottom: '12px' }}>
                            <Text strong style={{ fontSize: '13px', color: '#374151' }}>Choice</Text>
                        </div>
