...
export default function QuestionForm({ question, onChange, onRemove }: Props) {
    ...
    const addAnswer = () => {
        onChange({
            ...question,
            answers: [...question.answers, { variantText: "", answer: "", correct: false }],
        })
    }
        ...
        >
            ...
            <div style={{ marginBottom: "16px" }}>
                <div style={{ marginBottom: "8px" }}>
                    <label style={{ fontWeight: 500, color: "#374151", fontSize: "14px" }}>Savol matni</label>
                </div>
                <Input.TextArea
            ...
            <div style={{ marginBottom: "20px" }}>
                <div style={{ marginBottom: "8px" }}>
                    <label style={{ fontWeight: 500, color: "#374151", fontSize: "14px" }}>Savol turi</label>
                </div>
                <Select
                    value={question.type}
